...
class myListView extends StatelessWidget {
  ...
  Widget _buildScroll(){
    return Center(
      child: SingleChildScrollView(
        child: Column(
          children: [
            Container(width: 400,height: 140,color: Colors.red,),
            Container(width: 200,height: 80,color: Colors.amber,),
            Container(width: 100,height: 80,color: Colors.green,),
            Container(width: 50,height: 80,color: Colors.deepOrangeAccent,),
            Container(width: 90,height: 80,color: Colors.white10,),
  ...
  Widget _buildListView1(){
    return ListView(
      ...
      children: [
        Container(width: 70,height: 140,color: Colors.red,),
        Container(width: 70,height: 300,color: Colors.amber,),
        Container(width: 70,height: 80,color: Colors.green,),
        Container(width: 70,height: 80,color: Colors.deepOrangeAccent,),
        Container(width: 70,height: 80,color: Colors.white10,),
        Container(width: 70,height: 140,color: Colors.red,),
        Container(width: 70,height: 80,color: Colors.amber,),
        Container(width: 70,height: 80,color: Colors.green,),
        Container(width: 70,height: 80,color: Colors.deepOrangeAccent,),
        Container(width: 70,height: 80,color: Colors.white10,),
      ],
